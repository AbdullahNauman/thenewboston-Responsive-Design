	...
	<div id="content-wrapper">
		...
		<div class="mail-nav">
			...
			<div class="navigation">
				<ul class="sections">
					<li><a href="messages_inbox.php"><i class="m-nav-icon fa fa-envelope"></i>Inbox <span class="label pull-right">20</span></a></li>
					<li><a href="messages_sent.php"><i class="m-nav-icon fa fa-share"></i>Sent</a></li>
					<li class="active"><a href="messages_trash.php"><i class="m-nav-icon fa fa-trash"></i>Trash</a></li>
					<li class="divider"></li>
				</ul>
